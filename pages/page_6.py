...
st.sidebar.button(
    "Start", disabled=st.session_state.stream, on_click=toggle_stream
)

st.sidebar.button(
    "Stop", disabled=not st.session_state.stream, on_click=toggle_stream
)
